...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	printf("Starting >> STM32F407G-DISC1_SPI-Continous-PDM-data_to_MCU-DAC-Pin_DAC-Amp_DMA \n");
	...
	//HAL_I2S_Transmit_DMA(&hi2s3, (uint16_t *) PCM_outBuffer, 2);

	HAL_TIM_Base_Start(&htim2); //Start the timer

	HAL_Delay(100);

	printf("Ending   >> STM32F407G-DISC1_SPI-Continous-PDM-data_to_MCU-DAC-Pin_DAC-Amp_DMA \n");
